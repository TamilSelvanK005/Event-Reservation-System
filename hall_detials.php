                ...
                <div class="wow fadeInUp" data-wow-delay="0.5s">
                    <form action="hall_add_API.php" method="post">
                        <div class="row g-3">
                            ...
                            <div class="col-md-16">
                                <div class="form-floating">
									<textarea class="form-control" style="height:120px" name="hall_add" id="email" readonly="readonly" rows="4" cols="50" ><?php echo $row['hall_address']?></textarea>
                           ...
                           <div class="col-md-12">
							...
							<div class="col-md-12">
                                ...
                                <div class="form-floating">
                                     <div class="col-12">
									  <div class="col-12">
									  <a  class="btn btn-primary" href="hall_detials.php?key=<?php echo $row['wh_id']?>">VIEW</a>
