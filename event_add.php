    ...
    <div class="container">
        <div class="col-md-6">
                <div class="wow fadeInUp" data-wow-delay="0.5s">
                    <form action="events_add_API.php" method="post" enctype="multipart/form-data">
                        <div class="row g-3">
                            <div class="col-md-6">
                                <div class="form-floating">
                                    <input type="text" class="form-control" name="event_name" id="name" placeholder="Your Name" required>
					  	...
					  	<div class="col-md-6">
							...
							<div class="form-floating">
                                    <input type="text" class="form-control" name="pass" id="name" placeholder="Password" required>
                                    <label for="name">Password</label>
                                </div>
						</div>
						<div class="col-md-6">
                                <div class="form-floating">
                                    <input type="text" class="form-control" name="cus_name" id="name" placeholder="Your Name" required>
                                    <label for="name">Customer Name</label>
                                </div>
                            </div>
							<div class="col-md-6">
                                <div class="form-floating">
                                    <input type="text" class="form-control" name="cus_no" id="name" placeholder="Your Name" required>
...
<br>
                            ...
                            <div class="col-12">
                                <input type="submit" class="btn btn-danger w-100 py-3" value="submit"  name="submit">
                            </div>
                        </div>
                    </form>
                </div>
