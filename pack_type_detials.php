 ...
 <div class="container-xxl py-5">
            <div class="container">
                <div class="bg-light rounded p-3">
                    ...
                    <form action="events_delete_API.php" method="post">
                                        <div class="row g-3">
                                            <div class="col-md-6">
                                                <div class="form-floating">
                                    <input type="text" class="form-control" name="events_name" id="name"  readonly value="<?php echo $row['pack_name']?>">
									 <input type="hidden" class="form-control" name="key" id="name"  readonly value="<?php echo $row['pack_id']?>">
							 ...
							 <div class="col-md-6">
                                <div class="form-floating">
                                    <input type="file" class="form-control" name="uploadfile" id="name" value="<?php echo $row['image']?>" readonly>
                                    <label for="name">Image</label>
                            	                ...
                            	                <div class="col-md-12">
                                                  <div class="form-floating">
                                                    <div class="col-12">
									                    <div class="col-12">
									 <a  class="btn btn-primary" href="pack_detials.php?key<?php echo $row['pack_id']?>">VIEW</a>
										
										<a  class="btn mr-md-2 mb-md-0 mb-2 btn-success" href="pack_type_update.php?key=<?php echo $row['pack_id']?>">EDIT</a>
									    <a  class="btn mr-md-2 mb-md-0 mb-2 btn-danger" href="pack_type_delete.php?key=<?php echo $row['pack_id']?>">DELETE</a>								                    </div>
							                        </div>
                                                </div>
                                        </div>
