    ...
    <div class="container">
        <div class="col-md-6">
                <div class="wow fadeInUp" data-wow-delay="0.5s">
                    <form action="offer_add_API.php" method="post" enctype="multipart/form-data">
                        <div class="row g-3">
                            <div class="col-md-12">
                                <div class="form-floating">
                                    <input type="text" class="form-control" name="off_name" id="name" placeholder="Your Name" required >
                                    <label for="name">Offer Name</label>
                                </div>
                            </div>
                            <div class="col-md-12">
                                <div class="form-floating">
                                    <input type="text" class="form-control" name="off_con" id="email" placeholder="Your Email" required>
                                    <label for="Address">Offer Content</label>
                                </div>
                            </div>
							<div class="col-md-6">
                                <div class="form-floating">
