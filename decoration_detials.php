                ...
                <div class="bg-light rounded p-3">
                    <div class="bg-white rounded p-4" style="border: 1px dashed rgba(0, 120, 80, .3)">
                        <div class="row g-5 align-items-center">
						 ...
						 $sql="SELECT * FROM decoration WHERE dec_id='$key'";
						 ...
						 ?>
                            <div class="col-lg-6 wow fadeIn" data-wow-delay="0.1s">
                                <img class="img-fluid rounded w-100" src="<?php echo $row['image']?>" alt="">
                            </div>
                            <div class="col-lg-6 wow fadeIn" data-wow-delay="0.5s">
                                <div class="mb-4">
                                    <h1 class="mb-3">Choose Your Theme Based Decoration..</h1>
                                    <p></p>
                               </div>
                        ...
                        <div class="row g-3">
                            <div class="col-md-12">
                                <div class="form-floating">
                                    <input type="text" class="form-control" name="hall_name" id="name"  readonly value="<?php echo $row['decoration_name']?>">
                                ...
                                <div class="form-floating">
                                     <div class="col-12">
									  <div class="col-12">
									  <a type="submit" class="btn btn-danger"  href="decorationbook.php?key=<?php echo $row['dec_id']?>">BOOK NOW</a>
									  </div>
							    </div>
                                </div>
                            </div>
		...
		<div class="container-xxl py-5">
            <div class="container">
                <div class="text-center mx-auto mb-5 wow fadeInUp" data-wow-delay="0.1s" style="max-width: 600px;">
                    <h1 class="mb-3">Decoration Collection </h1>
                    <p>Eirmod sed ipsum dolor sit rebum labore magna erat. Tempor ut dolore lorem kasd vero ipsum sit eirmod sit. Ipsum diam justo sed rebum vero dolor duo.</p>
                </div>
                <div class="row g-4">
                    <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.1s" style="filter:drop-shadow(0 0 0.75rem crimson)">
                        <div class="property-item rounded overflow-hidden team-item rounded">
                            <div class="position-relative">
                                <img class="img-fluid" src="img/0_LreeOTZarIP39egS.webp" alt="" width="400px" height="400px">
                                
                            </div>
                            
                        </div>
                    </div>
                    <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.3s" style="filter:drop-shadow(0 0 0.75rem crimson)">
                        <div class="property-item rounded overflow-hidden team-item rounded">
                            <div class="position-relative">
                                <img class="img-fluid" src="img/1483625069_IMG_20151208_WA0033.webp"
                    ...
                    <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.5s" style="filter:drop-shadow(0 0 0.75rem crimson)">
                        <div class="property-item rounded overflow-hidden team-item rounded">
                            <div class="position-relative">
                                <img class="img-fluid" src="img/0_KAQrRsA5iEG0gCPL.webp" alt="" width="400px" height="400px">
                                
                            </div>
                            
                        </div>
                    </div>
                    <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.7s" style="filter:drop-shadow(0 0 0.75rem crimson)">
                        <div class="property-item rounded overflow-hidden team-item rounded">
                            <div class="position-relative" >
                                <img class="img-fluid" src="img/0_Z3YWYShoMJhDtBpA.webp" alt="" width="400px" height="400px">
					 ...
					 <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.9s" style="filter:drop-shadow(0 0 0.75rem crimson)">
                        <div class="property-item rounded overflow-hidden team-item rounded">
                            <div class="position-relative" >
                                <img class="img-fluid" src="img/628--2048x1366.jpg" alt="" width="400px" height="400px">
                                <div class="position-absolute start-50 top-100 translate-middle d-flex align-items-center">
                                </div>
                            </div>
					 ...
					 <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.11s" style="filter:drop-shadow(0 0 0.75rem crimson)">
                        <div class="property-item rounded overflow-hidden team-item rounded">
                            <div class="position-relative" >
                                <img class="img-fluid" src="img/image6817.webp" alt="" width="400px" height="400px">
                                <div class="position-absolute start-50 top-100 translate-middle d-flex align-items-center">
                                </div>
                            </div>
					 ...
					 <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.13s" style="filter:drop-shadow(0 0 0.75rem crimson)">
                        <div class="property-item rounded overflow-hidden team-item rounded">
                            <div class="position-relative" >
                                <img class="img-fluid" src="img/0_Bm85ffNDUFgpm0zO.webp" alt="" width="400px" height="400px">
                                <div class="position-absolute start-50 top-100 translate-middle d-flex align-items-center">
                                </div>
                            </div>
					 ...
					 <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.15s" style="filter:drop-shadow(0 0 0.75rem crimson)">
                        <div class="property-item rounded overflow-hidden team-item rounded">
                            <div class="position-relative" >
                                <img class="img-fluid" src="img/0_LreeOTZarIP39egS.webp" alt="" width="400px" height="400px">
                                <div class="position-absolute start-50 top-100 translate-middle d-flex align-items-center">
