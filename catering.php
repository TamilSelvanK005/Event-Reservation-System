         ...
         <div class="container-fluid nav-bar bg-transparent">
            <nav class="navbar navbar-expand-lg bg-white navbar-light py-0 px-4">
                <a href="" class="navbar-brand d-flex align-items-center text-center">
                    ...
                    <h1 class="m-0 text-black" style="font-family:Arial, Helvetica, sans-serif; font-size:30px"><marquee>WEDD<img class="img-fluid" src="img/20230921_211420.png" alt="Icon" style=" height: 80px;">PLANER</marquee></h1>
                </a>
                            ...
                            <div class="col-lg-6 wow fadeIn" data-wow-delay="0.5s">
                                <div class="mb-4">
                                    <h1 class="mb-3"><?php echo $row['company_name']?></h1>
									 <input type="hidden" class="form-control" name="key"  value="<?php echo $row['cat_id']?>" >
                                    <p></p>
                                </div>
                               
                                <div class="col-12">
									  <div class="col-12">
									  <a  class="btn mr-md-2 mb-md-0 mb-2 btn-danger" href="food_catagory.php?key=<?php echo $row['cat_id']?>">MORE DETAILS</a>
									  </div>
							    </div>
                            </div>
							 <?php
