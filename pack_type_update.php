    ...
    <div class="container">
        <div class="col-md-12">
                <div class="wow fadeInUp" data-wow-delay="0.5s">
                    <form action="pack_type_update_API.php" method="post">
                        <div class="row g-3">
                            <div class="col-md-12">
							...
							<div class="col-md-6">
                                <div class="form-floating">
                                    <input type="text" class="form-control" name="ser_1" id="name" value="<?php echo $row['service_1']?>" >
                                    <label for="name">Service_1</label>
                                </div>
                            </div>
							 <div class="col-md-6">
                                <div class="form-floating">
                                    <input type="text" class="form-control" name="ser_2" id="name" value="<?php echo $row['service_2']?>" >
                                    <label for="name">Service_2</label>
                                </div>
                            </div>
							 <div class="col-md-6">
                                <div class="form-floating">
                                    <input type="text" class="form-control" name="ser_3" id="name" value="<?php echo $row['service_3']?>" >
                                    <label for="name">Service_3</label>
                                </div>
                            </div>
							 <div class="col-md-6">
                                <div class="form-floating">
                                    <input type="text" class="form-control" name="ser_4" id="name" value="<?php echo $row['service_4']?>" >
							 ...
							 <div class="col-md-6">
                                <div class="form-floating">
                                    <input type="text" class="form-control" name="ser_5" id="name" value="<?php echo $row['service_5']?>" >
                                    <label for="name">Service_5 </label>
                                </div>
                            </div>
							 <div class="col-md-6">
                                <div class="form-floating">
                                    <input type="text" class="form-control" name="ser_6" id="name" value="<?php echo $row['service_6']?>" >
