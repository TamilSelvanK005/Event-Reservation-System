                ...
                <div class="wow fadeInUp" data-wow-delay="0.5s">
                    <form action="try.php" method="post">
                        <div class="row g-3">
                            <div class="col-md-12">
                                <div class="form-floating">
									...
									<input type="hidden" class="form-control" name="key"  value="<?php echo $row['cat_id']?>" ><br>
						<label for="name">Service Name</label>
									...
									<p style="color:red"><b>* SELECT THE FOOD STYLE</b></p>
									
                                    
                                </div>
                            </div>
                            <input type="submit" class="btn mr-md-2 mb-md-0 mb-2 btn-danger" name="submit"  >
                            	<div class="col-md-12">
                                <div class="form-floating">
                                     <div class="col-12">
									  <div class="col-12">									   
