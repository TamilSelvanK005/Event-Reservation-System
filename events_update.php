                ...
                <div class="bg-light rounded p-3">
                    <div class="bg-white rounded p-4" style="border: 1px dashed rgba(0, 120, 80, .3)">
                        <div class="row g-5 align-items-center">
						 ...
						 $sql="SELECT * FROM customer_login WHERE id='$key'";
                    ...
                    <form action="events_update_API.php" method="post">
                                        <div class="row g-3">
                                            <div class="col-md-6">
                                                <div class="form-floating">
                                    <input type="text" class="form-control" name="events_name" id="name"   value="<?php echo $row['cus_name']?>">
									 <input type="hidden" class="form-control" name="key" id="name"  readonly value="<?php echo $row['id']?>">
											...
											<div class="col-md-6">
                                                <div class="form-floating">
                                    <input type="text" class="form-control" name="id" id="name"   value="<?php echo $row['cuid']?>">
                                                     <label for="name">Customer ID</label>
                                                </div>
                                            </div>
											<div class="col-md-6">
                                                <div class="form-floating">
                                    <input type="text" class="form-control" name="pass" id="name"   value="<?php echo $row['pass']?>">
                            	                ...
                            	                <div class="col-md-12">
                                                  <div class="form-floating">
                                                    <div class="col-12">
									                    <div class="col-12">
<input type="submit"  class="btn mr-md-2 mb-md-0 mb-2 btn-success" name="update" value="UPDATE" >									                    </div>
							                        </div>
                                                </div>
                                        </div>
