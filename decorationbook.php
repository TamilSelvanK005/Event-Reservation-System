                        ...
                        <div class="row g-5 align-items-center">
						 ...
						 ?>
                            ...
                            <div class="col-lg-6 wow fadeIn" data-wow-delay="0.5s">
                                <div class="mb-4">
                                    <h1 class="mb-3"><?php echo strtoupper($row['decoration_name'])?></h1>
                                    <p></p>
                               </div>
    ...
    <div class="container">
        <div class="col-md-12">
                <div class="wow fadeInUp" data-wow-delay="0.5s">
                    <form action="decorationbook_API.php" method="post">
                        <div class="row g-3">
                            <div class="col-md-12">
                                <div class="form-floating">
                                    <input type="text" class="form-control" name="dec_name" id="name"  readonly value="<?php echo $row['decoration_name']?>">
                                    <label for="name">Decoration Name</label>
                                </div>
                            </div>
                            <div class="col-md-12">
                                <div class="form-floating">
								 <input type="text" class="form-control" name="dname" id="email" placeholder="Name" readonly value="<?php echo htmlspecialchars($_SESSION["user_name"]); ?>">
									 <input type="hidden" class="form-control" name="key"  value="<?php echo $row['dec_id']?>" >
                            ...
                            <div class="col-md-12">
                                <div class="form-floating">
                                    ...
                                    <label for="Rooms">Decoration Spot</label>
                                </div>
                            </div>
							<div class="col-md-12">
                                <div class="form-floating">
                                    <input type="text" class="form-control" name="spot1" id="email"  >
                                    <label for="Rooms">Re-Enter The Spot</label>
                                </div>
                            </div>
							...
							<div class="col-md-12">
                                <div class="form-floating">
								    ...
								    <h2>Select Your Session Days</h2><select name="days" style="width:300px; height:50px" >
										<option value="Morning">1 Day</option>
										<option value="Evening">2 Days</option>
										<option value="One Day">3 Days</option>
										<option value="Two Days">4 Days</option>
										<option value="Three Days">5 Days</option>
					...
					<input type="submit"  class="btn btn-danger px-3 d-none d-lg-flex" name="submit" value="BOOK NOW!" >
