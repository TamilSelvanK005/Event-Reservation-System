    ...
    <div class="container">
        <div class="col-md-6">
                <div class="wow fadeInUp" data-wow-delay="0.5s">
                    <form action="package_add_API.php" method="post" enctype="multipart/form-data">
                        <div class="row g-3">
                            <div class="col-md-6">
                                <div class="form-floating">
                                    <input type="text" class="form-control" name="pack_name" id="name" placeholder="Your Name" required>
                                    <label for="name">Package Name</label>
                                </div>
                            </div>
                             <div class="col-md-6">
                                <div class="form-floating">
                                    <input type="text" class="form-control" name="ser_1" id="name" placeholder="Service_1" required>
                                    <label for="name">Service_1</label>
                                </div>
                            </div>
							 <div class="col-md-6">
                                <div class="form-floating">
                                    <input type="text" class="form-control" name="ser_2" id="name" placeholder="Service_2" required>
                                    <label for="name">Service_2</label>
                                </div>
                            </div>
							 <div class="col-md-6">
                                <div class="form-floating">
                                    <input type="text" class="form-control" name="ser_3" id="name" placeholder="Service_3" required>
                                    <label for="name">Service_3</label>
                                </div>
                            </div>
							 <div class="col-md-6">
                                <div class="form-floating">
                                    <input type="text" class="form-control" name="ser_4" id="name" placeholder="Service_4" required>
							 ...
							 <div class="col-md-6">
                                <div class="form-floating">
                                    <input type="text" class="form-control" name="ser_5" id="name" placeholder="Service_5" required>
                                    <label for="name">Service_5 </label>
                                </div>
                            </div>
							 <div class="col-md-6">
                                <div class="form-floating">
                                    <input type="text" class="form-control" name="ser_6" id="name" placeholder="Service_6" required>
                                    <label for="name">Service_6 </label>
                                </div>
                            </div>
							 <div class="col-md-6">
                                <div class="form-floating">
                                    <input type="file" class="form-control" name="uploadfile" id="name" placeholder="Image" required>
