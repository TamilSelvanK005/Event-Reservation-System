                ...
                <div class="bg-light rounded p-3">
                    <div class="bg-white rounded p-4" style="border: 1px dashed rgba(0, 120, 80, .3)">
                        <div class="row g-5 align-items-center">
						 ...
						 $sql="SELECT * FROM dj_setup WHERE dj_id='$key'";
    ...
    <div class="container">
        <div class="col-md-12">
                <div class="wow fadeInUp" data-wow-delay="0.5s">
                    <form action="djsetup_book_API.php" method="post">
                        <div class="row g-3">
                            <div class="col-md-12">
                            ...
                            <div class="col-md-12">
                                <div class="form-floating">
                                    <input type="text" class="form-control" name="aname" id="email" placeholder="Name" readonly value="<?php echo htmlspecialchars($_SESSION["user_name"]); ?>">
									 <input type="hidden" class="form-control" name="key"  value="<?php echo $row['dj_id']?>" >
