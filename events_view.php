                                        ...
                                        <div class="row g-3">
                                            <div class="col-md-6">
                                                <div class="form-floating">
                                                     <input type="text" class="form-control" name="hall_name" id="name"  readonly value="<?php echo $row['cus_name']?>">
                            	                ...
                            	                <div class="col-md-12">
                                                  <div class="form-floating">
                                                    <div class="col-12">
									                    <div class="col-12">
									                         <a  class="btn btn-primary" href="events_view.php?key=<?php echo $row['id']?>">VIEW</a>
										                     <a  class="btn mr-md-2 mb-md-0 mb-2 btn-success" href="events_update.php?key=<?php echo $row['id']?>">EDIT</a>
									                         <a  class="btn mr-md-2 mb-md-0 mb-2 btn-danger" href="events_delete.php?key=<?php echo $row['id']?>">DELETE</a>
									                    </div>
							                        </div>
                                                </div>
                                        </div>
