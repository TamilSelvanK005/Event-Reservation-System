            ...
            <div class="container">
             ...
             ?>
                            ...
                            <div class="col-lg-6 wow fadeIn" data-wow-delay="0.5s">
                                <div class="mb-4">
                                    <h1 class="mb-3"></h1>
                                    <p style="color:#000000"><?php echo $row['off_name']?></p>
									<p style="color:#000000"><?php echo $row['offer_content']?></p>
                                </div>
                               
                                <div class="col-12">
									  <div class="col-12">
									
									   <a  class="btn mr-md-2 mb-md-0 mb-2 btn-success" href="offer_update.php?key=">UPDATE</a>
									    <a  class="btn mr-md-2 mb-md-0 mb-2 btn-danger" href="offer_delete.php?key=<?php echo $row['offer_id']?>">DELETE</a>
