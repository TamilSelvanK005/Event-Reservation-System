    ...
    <div class="container">
        <div class="col-md-12">
                <div class="wow fadeInUp" data-wow-delay="0.5s">
                    <form action="hallbooknow_API.php" method="post">
                        <div class="row g-3">
                            <div class="col-md-12">
                            ...
                            <div class="col-md-12">
                                <div class="form-floating">
                                    <input type="text" class="form-control" name="cname" id="email" placeholder="Name" readonly value="<?php echo htmlspecialchars($_SESSION["user_name"]); ?>">
                            ...
                            <div class="col-12">
                                <div class="form-floating">
                                    <input type="text" class="form-control" name="country" id="subject" readonly  value="<?php echo htmlspecialchars($_SESSION["country"]); ?>" >
                            ...
                            <div class="col-md-12">
							 ...
							 <div class="col-md-12">
                                <div class="form-floating">
                                    <input type="mail" class="form-control" name="mail" readonly id="email" value="<?php echo htmlspecialchars($_SESSION["mail_id"]); ?>" >
                            ...
                            <div class="col-md-12">
                                <div class="form-floating">
                                    <input type="text" class="form-control" name="bride" id="email"  >
                                    <label for="Rooms">Bride Name</label>
                                </div>
                            </div>
                           <div class="col-md-12">
                                <div class="form-floating">
                                    <input type="text" class="form-control" name="groom" id="email"  >
                                    <label for="AC/Non AC">Groom Name</label>
                                </div>
                            </div>
							<div class="col-md-12">
                                <div class="form-floating">
							...
							<div class="col-md-12">
                                <div class="form-floating">
                                    <input type="text" class="form-control" name="guru" id="email" >
                                    <label for="Restroom">Morning/Evening</label>
                                </div>
                            </div>
