                ...
                <div class="bg-light rounded p-3">
                    <div class="bg-white rounded p-4" style="border: 1px dashed rgba(0, 120, 80, .3)">
                        <div class="row g-5 align-items-center">
						 ...
						 $sql="SELECT * FROM package_booking WHERE id ='$key'";
                        ...
                        <div class="container">
                            <div class="col-md-12">
                                <div class="wow fadeInUp" data-wow-delay="0.5s">
                                    <form action="catagory_pack_API.php" method="post">
                                        <div class="row g-3">
                                            <div class="col-md-6">
                                                <div class="form-floating">
                                                     <input type="text" class="form-control" name="hall_name" id="name"  readonly value="<?php echo $row['pack_name']?>">
													 <input type="hidden" class="form-control" name="key" id="name"  readonly value="<?php echo $row['id']?>">
							...
							<div class="col-md-6">
                                <div class="form-floating">
                                    <input type="text" class="form-control" name="ser_2" id="name" value="<?php echo $row['mail_id']?>" readonly>
                                    <label for="name">CUSTOMER MAIL</label>
                                </div>
                            </div>
							 <div class="col-md-6">
                                <div class="form-floating">
                                    <input type="text" class="form-control" name="ser_2" id="name" value="<?php echo $row['number1']?>" readonly>
							 ...
							 <div class="col-md-6">
                                <div class="form-floating">
                                    <input type="text" class="form-control" name="ser_4" id="name" value="<?php echo $row['number2']?>" readonly>
                                    <label for="name">CUSTOMER NUMBER </label>
                                </div>
                            </div>
							 ...
							 <div class="col-md-6">
                                <div class="form-floating">
                                    <input type="text" class="form-control" name="ser_5" id="name" value="<?php echo $row['address']?>" readonly>
							 ...
							 <div class="col-md-6">
                                <div class="form-floating">
                                    <input type="text" class="form-control" name="ser_6" id="name" value="<?php echo $row['sport_location']?>" readonly>
