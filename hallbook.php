	...
	<div class="container-xxl py-5">
            <div class="container">
                <div class="bg-light rounded p-3">
                    <div class="movie-night rounded p-4" style="border: 1px dashed rgba(0, 120, 80, .3)">
                ...
                <div class="wow fadeInUp" data-wow-delay="0.5s">
                    <form action="" method="post">
                        <div class="row g-3">
                            ...
                            <div class="col-md-12">
                                <div class="form-floating">
                                    <input type="text" class="form-control" name="hall_add" id="email" value="<?php echo $row['hall_address']?>" readonly >
                                    <label for="Address">Hall Address</label>
                                </div>
                            </div>
                            <div class="col-12">
                                <div class="form-floating">
                                    <input type="text" class="form-control" name="no_seats" id="subject" value="<?php echo $row['no_of_seats']?>" readonly >
                                    <label for="seats">No-of-Seats</label>
                                </div>
                            </div>
                            <div class="col-md-12">
                                <div class="form-floating">
                                    <input type="text" class="form-control" name="dinner" id="email" value="<?php echo $row['dinner_seats']?>" readonly >
                                    <label for="Dinner">Dinner seats</label>
                                </div>
                            </div>
                            <div class="col-md-12">
                                <div class="form-floating">
                                    <input type="text" class="form-control" name="no_room" id="email" value="<?php echo $row['no_rooms']?>" readonly>
                                    <label for="Rooms">No-Rooms</label>
                                </div>
                            </div>
                           <div class="col-md-12">
                                <div class="form-floating">
                                    <input type="text" class="form-control" name="AC" id="email" value="<?php echo $row['ac_non_ac']?>" readonly>
                                    <label for="AC/Non AC">AC/Non AC</label>
                                </div>
                            </div>
							<div class="col-md-12">
                                <div class="form-floating">
                                    <input type="text" class="form-control" name="restroom" id="email" value="<?php echo $row['restroom']?>" readonly>
                                    <label for="Restroom">Restroom</label>
                                </div>
                            </div>
							<div class="col-md-12">
                                <div class="form-floating">
                                    <input type="text" class="form-control" name="parking" id="email" value="<?php echo $row['parking']?>" readonly>
                                    <label for="Parking">Parking</label>
                                </div>
                            </div>
							<div class="col-md-12">
                                <div class="form-floating">
                                    <input type="text" class="form-control" name="light" id="email" value="<?php echo $row['lights']?>" readonly>
                                    <label for="Light">Light</label>
                                </div>
                            </div>
							<div class="col-md-12">
                                <div class="form-floating">
                                    <input type="text" class="form-control" name="people" id="email" value="<?php echo $row['cleaning_people']?>" readonly>
                                    <label for="Cleaning">Cleaning People</label>
                                </div>
                            </div>
							<div class="col-md-12">
                                <div class="form-floating">
                                    <input type="text" class="form-control" name="song" id="email" value="<?php echo $row['songs']?>"  readonly>
                                    <label for="Song">Auido Set</label>
                                </div>
                            </div>
							
							<div class="col-md-12">
                                <div class="form-floating">
                                    <input type="text" class="form-control" name="dinner1" id="email" value="<?php echo $row['dinner_veg']?>" readonly>
                                    <label for="veg">Kitchen Equment</label>
                                </div>
                            </div>
							<div class="col-md-12">
                                <div class="form-floating">
                                    <input type="text" class="form-control" name="dinner2" id="email" value="<?php echo $row['dinner_non']?>" readonly>
                                    <label for="non veg">Per Unit Current/Per Hour Genrator </label>
                                </div>
                            </div>
                            	<div class="col-md-12">
                                <div class="form-floating">
                                     <div class="col-12">
									  <div class="col-12">
									  <a type="submit" class="btn btn-danger"  href="hallbooknow.php?key=<?php echo $row['wh_id']?>">BOOK NOW</a>
									  </div>
							    </div>
                                </div>
                            </div>
