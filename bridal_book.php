                ...
                <div class="bg-light rounded p-3">
                    <div class="bg-white rounded p-4" style="border: 1px dashed rgba(0, 120, 80, .3)">
                        <div class="row g-5 align-items-center">
						 ...
						 $sql="SELECT * FROM artist WHERE ar_id='$key'";
						 ...
						 ?>
                            <div class="col-lg-6 wow fadeIn" data-wow-delay="0.1s">
                                <img class="img-fluid rounded w-100" src="img/IMG_20240105_210304.jpg" alt="">
                            </div>
                            <div class="col-lg-6 wow fadeIn" data-wow-delay="0.5s">
                                <div class="mb-4">
                                    <h1 class="mb-3"><?php echo $row['bridal']?></h1>
                                    <p></p>
                               </div>
    ...
    <div class="container">
        <div class="col-md-12">
                <div class="wow fadeInUp" data-wow-delay="0.5s">
                    <form action="bridal_book_API.php" method="post">
                        <div class="row g-3">
                            <div class="col-md-12">
                                <div class="form-floating">
                                    <input type="text" class="form-control" name="hall_name" id="name"  readonly value="<?php echo $row['bridal']?>">
                            ...
                            <div class="col-md-12">
                                <div class="form-floating">
                                    <input type="text" class="form-control" name="aname" id="email" placeholder="Name" readonly value="<?php echo htmlspecialchars($_SESSION["user_name"]); ?>">
									 <input type="hidden" class="form-control" name="key"  value="<?php echo $row['ar_id']?>" >
                            ...
                            <div class="col-md-12">
                                <div class="form-floating">
                                    ...
                                    <label for="Rooms">Service Spot</label>
                                </div>
                            </div>
							<div class="col-md-12">
                                <div class="form-floating">
