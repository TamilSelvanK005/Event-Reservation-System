                        ...
                        <div class="row g-3">
                            <div class="col-md-12">
                                <div class="form-floating">
                                    <input type="text" class="form-control" name="pack_name" id="name"   value="<?php echo $row['cus_name']?>">
                                    <label for="name">Pack Name</label>
                                </div>
                            </div>
                            <div class="col-md-12">
                                <div class="form-floating">
									 <input type="hidden" class="form-control" name="key"  value="<?php echo $row['id']?>" >
