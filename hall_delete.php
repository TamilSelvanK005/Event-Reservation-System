    ...
    <div class="container">
        <div class="col-md-12">
                <div class="wow fadeInUp" data-wow-delay="0.5s">
                    <form action="hall_delete_API.php" method="post">
                        <div class="row g-3">
                            <div class="col-md-12">
                                <div class="form-floating">
                                    <input type="text" class="form-control" name="hall_name" id="name"  readonly value="<?php echo $row['hall_name']?>">
												<input type="hidden" class="form-control" name="key"  value="<?php echo $row['wh_id']?>" >
                            ...
                            <div class="col-md-12">
                                <div class="form-floating">
<textarea class="form-control" style="height:120px" name="hall_add" id="email" readonly="readonly" rows="4" cols="50" ><?php echo $row['hall_address']?></textarea>                                    <label for="Address">Hall Address</label>
                                </div>
                            </div>
                            <div class="col-12">
                                <div class="form-floating">
