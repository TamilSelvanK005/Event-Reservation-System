                ...
                <div class="bg-light rounded p-3">
                    <div class="bg-white rounded p-4" style="border: 1px dashed rgba(0, 120, 80, .3)">
                        <div class="row g-5 align-items-center">
						 ...
						 $sql="SELECT * FROM enquery WHERE en_id ='$key'";
                        ...
                        <div class="container">
                            <div class="col-md-12">
                                <div class="wow fadeInUp" data-wow-delay="0.5s">
                                    <form action="enquery_API.php" method="post">
                                        <div class="row g-3">
                                            <div class="col-md-6">
                                                <div class="form-floating">
                                                     <input type="text" class="form-control" name="hall_name" id="name"  readonly value="<?php echo $row['email']?>">
													 <input type="hidden" class="form-control" name="key" id="name"  readonly value="<?php echo $row['en_id']?>">
							...
							<div class="col-md-6">
                                <div class="form-floating">
                                    <input type="text" class="form-control" name="ser_1" id="name" value="<?php echo $row['subject']?>" readonly>
                                    <label for="name">CUSTOMER NAME</label>
                                </div>
                            </div>
							<div class="col-md-6">
                                <div class="form-floating">
                                    <input type="text" class="form-control" name="ser_2" id="name" value="<?php echo $row['message']?>" readonly>
