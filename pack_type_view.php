                                            ...
                                            <div class="col-md-6">
                            	                ...
                            	                <div class="col-md-12">
                                                  <div class="form-floating">
                                                    <div class="col-12">
									                    <div class="col-12">
									                         <a  class="btn btn-primary" href="pack_type_detials.php?key=<?php echo $row['pack_id']?>">VIEW</a>
										                     <a  class="btn mr-md-2 mb-md-0 mb-2 btn-success" href="pack_type_update.php?key=<?php echo $row['pack_id']?>">EDIT</a>
									                         <a  class="btn mr-md-2 mb-md-0 mb-2 btn-danger" href="pack_type_delete.php?key=<?php echo $row['pack_id']?>">DELETE</a>
									                    </div>
							                        </div>
                                                </div>
                                        </div>
