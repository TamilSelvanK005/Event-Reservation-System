		            ...
		            <div class="container-xxl py-5">
                        <div class="container">
							...
							<div class="col-md-6">
							 ...
							 <div class="col-md-6">
                                <div class="form-floating">
                                    <input type="text" class="form-control" name="ser_6" id="name" value="<?php echo $row['spot_location']?>" readonly>
							 ...
							 <div class="col-md-12">
                                <div class="form-floating">
                                    <input style="height:200px" type="text" class="form-control" name="ser_6" id="name" value="<?php echo $row['food_menu']?>" readonly>
                                    <label for="name">FOOD MENUS </label>
                                </div>
                            </div>
							 <div class="col-md-6">
                                <div class="form-floating">
					 ...
					 <input type="submit"  class="btn mr-md-2 mb-md-0 mb-2 btn-outline-success" value="REJECT" name="reject">
				 <input type="submit"  class="btn mr-md-2 mb-md-0 mb-2 btn-outline-danger" value="PROCESS" name="process">
									                    </div>
							                        </div>
                                                </div>
                                        </div>
