                ...
                <div class="bg-light rounded p-3">
                    <div class="bg-white rounded p-4" style="border: 1px dashed rgba(0, 120, 80, .3)">
                        <div class="row g-5 align-items-center">
						 ...
						 $sql="SELECT * FROM booking WHERE book_id ='$key'";
		            ...
		            <div class="container-xxl py-5">
                        <div class="container">
                            <div class="col-md-12">
                                <div class="wow fadeInUp" data-wow-delay="0.5s">
                                    <form action="catagory_hall_API.php" method="post">
                                        <div class="row g-3">
                                            <div class="col-md-6">
							...
							<div class="col-md-6">
                                <div class="form-floating">
                                    <input type="text" class="form-control" name="ser_1" id="name" value="<?php echo $row['cus_name']?>" readonly>
                                    <label for="name">CUSTOMER NAME</label>
                                </div>
                            </div>
							<div class="col-md-6">
                                <div class="form-floating">
                                    <input type="text" class="form-control" name="ser_2" id="name" value="<?php echo $row['cus_country']?>" readonly>
                                    <label for="name">CUSTOMER COUNTRY</label>
                                </div>
                            </div>
							 <div class="col-md-6">
                                <div class="form-floating">
                                    <input type="text" class="form-control" name="ser_2" id="name" value="<?php echo $row['cus_city']?>" readonly>
                                    <label for="name">CUSTOMER CITY</label>
                                </div>
                            </div>
							 <div class="col-md-6">
                                <div class="form-floating">
                                    <input type="text" class="form-control" name="ser_3" id="name" value="<?php echo $row['cus_no1']?>" readonly>
                                    <label for="name">CUSTOMER NUMBER</label>
                                </div>
                            </div>
							 <div class="col-md-6">
                                <div class="form-floating">
                                    <input type="text" class="form-control" name="ser_4" id="name" value="<?php echo $row['cus_no2']?>" readonly>
                                    <label for="name">CUSTOMER NUMBER </label>
                                </div>
                            </div>
							 ...
							 <div class="col-md-6">
                                <div class="form-floating">
                                    <input type="text" class="form-control" name="ser_5" id="name" value="<?php echo $row['cus_email']?>" readonly>
                                    <label for="name">CUSTOMER MAIL </label>
                                </div>
                            </div>
							 <div class="col-md-6">
                                <div class="form-floating">
                                    <input type="text" class="form-control" name="ser_6" id="name" value="<?php echo $row['Bride_name']?>" readonly>
                                    <label for="name">BRIDE NAME </label>
                                </div>
                            </div>
							 <div class="col-md-6">
                                <div class="form-floating">
                                    <input type="text" class="form-control" name="ser_6" id="name" value="<?php echo $row['groom_name']?>" readonly>
                                    <label for="name">GROOM NAME </label>
                                </div>
                            </div>
							 <div class="col-md-6">
                                <div class="form-floating">
                                    <input type="text" class="form-control" name="ser_6" id="name" value="<?php echo $row['date']?>" readonly>
                                    <label for="name">DATE </label>
                                </div>
                            </div>
							 <div class="col-md-6">
                                <div class="form-floating">
                                    <input type="text" class="form-control" name="ser_6" id="name" value="<?php echo $row['session']?>" readonly>
                                    <label for="name">SESSION </label>
                                </div>
                            </div>
							 <div class="col-md-6">
                                <div class="form-floating">
                                    <input type="text" class="form-control" name="ser_6" id="name"  style="color:#FF0000" value="<?php echo strtoupper ($row['status'])?>" readonly>
					 ...
					 <input type="submit"  class="btn mr-md-2 mb-md-0 mb-2 btn-success" value="REJECT" name="reject">
				 <input type="submit"  class="btn mr-md-2 mb-md-0 mb-2 btn-danger" value="PROCESS" name="process">
									                    </div>
							                        </div>
                                                </div>
                                        </div>
