...
<img src="img/20230921_211420.png" height="100px">
 ...
 <a href="logout.php" class="btn btn-danger px-3 d-none d-lg-flex"><img src="img/download.png" width="30px" style="border-radius: 50%; padding-right:4px" ></img><?php echo htmlspecialchars($_SESSION["id"]);?></a>  					 </div>
            </nav>
        </div>
        <!-- Navbar End -->
...
<div class="container-xxl py-5">
    <div class="container">
        <div class="text-center mx-auto mb-5 wow fadeInUp" data-wow-delay="0.1s" style="max-width: 600px;">
            <h1 class="mb-3">IMAGE GALLERY</h1>
            <p>Being deeply loved by someone gives you strength, while loving someone deeply gives you courage.</p>
        </div>
        <div class="row g-4">
            <?php
			$key=htmlspecialchars($_SESSION["id"]);
			
            require_once "db_con.php";
            $sql = "SELECT * FROM gallery WHERE cuid='$key'";
            $result = mysqli_query($link, $sql);
                            
            if(mysqli_num_rows($result) > 0) {
                while($row = mysqli_fetch_array($result)) {
            ?>
            <div class="col-lg-4 col-md-4 wow fadeInUp  p-3 mb-5 rounded" data-wow-delay="0.1s">
                <div class="position-relative">
                    <a href="img/<?php echo $row['image']?>" data-fancybox="gallery">
                        <img class="img-fluid" src="img/<?php echo $row['image']?>" alt="">
                    </a>
                    <div class="position-absolute start-50 top-100 translate-middle d-flex align-items-center">
                        <a class="btn btn-square mx-1" href="img/<?php echo $row['image']?>" download style="background-color: #007bff;"><i class="bi bi-download"></i></a>
                    </div>
                </div>
            </div>
            <?php
