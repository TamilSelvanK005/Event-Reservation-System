                        ...
                        <div class="row g-5 align-items-center">
						 ...
						 ?>
                            <div class="col-lg-6 wow fadeIn" data-wow-delay="0.1s">
                                <img class="img-fluid rounded w-100" src="<?php echo $row['offer_image']?>" alt="">
                            </div>
    ...
    <div class="container">
        <div class="col-md-12">
                <div class="wow fadeInUp" data-wow-delay="0.5s">
                    <form action="offer_updateAPI.php" method="post">
                        <div class="row g-3">
                            <div class="col-md-12">
                                <div class="form-floating">
                                    <input type="text" class="form-control" name="off_name" id="name"  value="<?php echo $row['off_name']?>">
                                    <label for="name">Hall Name</label>
                                </div>
                            </div>
                            <div class="col-md-12">
                                <div class="form-floating">
                                    <input type="text" class="form-control" name="off_contant" id="email" value="<?php echo $row['offer_content']?>"  >
									 <input type="hidden" class="form-control" name="key"  value="<?php echo $row['offer_id']?>" >
